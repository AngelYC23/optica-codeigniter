    ...
    <div class="footer-content">
      <div class="social-links">
        <a href="https://www.facebook.com" target="_blank">
          <img class="icon" src="<?= base_url('assets/img/imagenes_promociones/facebook.png') ?>" alt="Facebook">
        </a>
  ...
  <a aria-label="Contactar por WhatsApp" class="whatsapp-btn" href="#" target="_blank">
